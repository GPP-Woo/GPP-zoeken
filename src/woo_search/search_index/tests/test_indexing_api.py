...
class DocumentAPITests(TokenAuthMixin, APITestCase):
    ...
    def test_document_api_happy_flow(self, patched_index_document):
        data = {
            ...
            "downloadUrl": "https://www.documents.com/downloads/1",
            "fileSize": 3124,
        }
        ...
        snake_case_data = {
            ...
            "download_url": "https://www.documents.com/downloads/1",
            "file_size": 3124,
        }
    ...
    def test_document_api_with_max_index_file_size_envvar_configured_without_file_size(
        self,
    ):
        data = {
