...
class SearchApiTest(TokenAuthMixin, VCRMixin, ElasticSearchAPITestCase):
    ...
    def test_search_informatie_categorieen(self):
        index_publication(
            uuid="5ed2de20-9af5-4578-8ae6-08f663a8c691",
            publisher={
                "uuid": "62da7e9d-2481-4d46-9c77-563b490126aa",
                "naam": "Utrecht",
            },
            informatie_categorieen=[
                {
                    "uuid": "f139d736-3191-4dee-824a-7dcab8f08a4d",
                    "naam": "GPP-publicatiebank",
                }
            ],
            officiele_titel="Lorem ipsum dolor sit amet, consectetur adipiscing elit.",
            verkorte_titel="Donec finibus non tortor quis sollicitudin.",
        ...
        index_publication(
            uuid="93cdbf75-4d74-4f19-a1e3-f1800c1f0ef2",
            publisher={
                "uuid": "62da7e9d-2481-4d46-9c77-563b490126aa",
                "naam": "Utrecht",
            },
            informatie_categorieen=[
                {"uuid": "830eae3a-0570-402c-b9f3-80cba70a39a8", "naam": "GPP-zoeken"}
            ],
            officiele_titel="Lorem ipsum dolor sit amet, consectetur adipiscing elit.",
            verkorte_titel="Donec finibus non tortor quis sollicitudin.",
            omschrijving="Nulla at nisi at enim eleifend facilisis at vitae velit.",
        ...
        index_publication(
            uuid="a8217b54-2e2d-4134-aa19-b3175f181c01",
            publisher={
                "uuid": "62da7e9d-2481-4d46-9c77-563b490126aa",
                "naam": "Utrecht",
            },
            informatie_categorieen=[
                {"uuid": "50ce010b-0492-4b00-a78a-ca3cf9abc72e", "naam": "GPP-app"}
            ],
            officiele_titel="Lorem ipsum dolor sit amet, consectetur adipiscing elit.",
            verkorte_titel="Donec finibus non tortor quis sollicitudin.",
            omschrijving="Nulla at nisi at enim eleifend facilisis at vitae velit.",
        ...
        with self.subTest("test with single uuid"):
            ...
            response = self.client.post(
                self.url,
                {"informatieCategorieen": ["f139d736-3191-4dee-824a-7dcab8f08a4d"]},
            )
            ...
            self.assertEqual(data["count"], 1)
            self.assertEqual(
                data["results"][0]["record"]["informatieCategorieen"][0]["uuid"],
                "f139d736-3191-4dee-824a-7dcab8f08a4d",
            )

        with self.subTest("test with multiple uuids"):
            # uuid of GPP-zoeken and GPP-publicatiebank
            response = self.client.post(
                self.url,
                {
                    "informatieCategorieen": [
                        "f139d736-3191-4dee-824a-7dcab8f08a4d",
                        "830eae3a-0570-402c-b9f3-80cba70a39a8",
                    ]
                },
            )
            ...
            self.assertEqual(
                data["results"][1]["record"]["informatieCategorieen"][0]["uuid"],
                "830eae3a-0570-402c-b9f3-80cba70a39a8",
            )
