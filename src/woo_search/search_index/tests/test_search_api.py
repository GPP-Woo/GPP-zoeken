    ...
    def test_query_field_boosts(self):
        ...
        index_document(
            **IndexDocumentFactory.build(
                ...
                download_url="http://localhost/document/one",
                file_size=20,
            )
        )
        index_document(
            **IndexDocumentFactory.build(
                ...
                omschrijving="omschrijving",
                download_url="http://localhost/document/two",
                file_size=20,
            )
        )
        index_document(
            **IndexDocumentFactory.build(
                ...
                download_url="http://localhost/document/three",
                file_size=20,
            )
        )
        index_document(
            **IndexDocumentFactory.build(
                ...
                verkorte_titel="verkorte titel",
                omschrijving="omschrijving",
                download_url="http://localhost/document/four",
                file_size=20,
            )
        )
        index_document(
