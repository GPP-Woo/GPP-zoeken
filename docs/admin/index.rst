...
'GPP-zoeken' comes with a minimal admin interface to perform basic administration.
...
* Licht/donker-button
   Door op deze button te klikken, kun je wisselen tussen een witte achtergrond of een zwarte achtergrond.
